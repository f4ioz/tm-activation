...
|---|---|
| ![Slot schedule](docs/images/planning.png) | ![Settings: map style and filters](docs/images/settings.png) |
...
- zip archive: <https://github.com/f4ioz/tm-activation/raw/main/releases/tm-activation-1.24.2.zip>
- tar.gz archive: <https://github.com/f4ioz/tm-activation/raw/main/releases/tm-activation-1.24.2.tar.gz>
