...
- zip archive: <https://github.com/f4ioz/tm-activation/raw/main/releases/tm-activation-1.22.3.zip>
- tar.gz archive: <https://github.com/f4ioz/tm-activation/raw/main/releases/tm-activation-1.22.3.tar.gz>
...
```bash
wget https://github.com/f4ioz/tm-activation/raw/main/releases/tm-activation-1.22.3.tar.gz
```
...
3. Copy the archive onto the Pi, from the PC:
   `scp tm-activation-1.22.3.tar.gz utilisateur@tm50abc.local:`
   (or download it straight onto the Pi with `wget`, see
   [Download](#download))
4. On the Pi:

   ```bash
   tar xzf tm-activation-1.22.3.tar.gz
   cd tm-activation-1.22.3
   sudo ./install.sh --lan
   ```
   ...
   ```bash
   unzip tm-activation-1.22.3.zip
   cd tm-activation-1.22.3
