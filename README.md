...
- Archive zip : <https://github.com/f4ioz/tm-activation/raw/main/releases/tm-activation-1.20.0.zip>
- Archive tar.gz : <https://github.com/f4ioz/tm-activation/raw/main/releases/tm-activation-1.20.0.tar.gz>
...
- **Espace opérateurs** (`/activation`), protégé par un mot de passe commun :
  ...
  - **Comptes opérateurs (au choix)** : mot de passe commun à tous, ou **un mot
    ...
    **administrateurs**. Réglages → Comptes opérateurs.
    Un opérateur ordinaire **reste sur son indicatif** : il logue, réserve ses
    créneaux, importe et exporte sous son seul indicatif, et ne peut ni modifier
    ni supprimer les QSO et les créneaux des autres. Il voit le log complet de la
    station — utile pour repérer les doublons — mais ses exports ne contiennent
    que ses propres QSO. Les administrateurs, eux, gardent la main sur tout.
